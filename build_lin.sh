...
export CGO_CFLAGS="-DLIN=1 -DSPNG_STATIC -DSPNG_USE_MINIZ -O2"
export CGO_CXXFLAGS="-std=c++20 -DLIN=1 -DSPNG_STATIC -DSPNG_USE_MINIZ -Wall -O2 -I${this_dir}/SDK/CHeaders/XPLM"
